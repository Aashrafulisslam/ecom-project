                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputUsername1" value="{{ $adminInfo['name'] }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email address</label>
                                <input type="email" class="form-control" id="exampleInputEmail1" value="{{ $adminInfo['email'] }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Currnet Password</label>
                                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter Currnet Password">
                            </div>
                            <div class="form-group">
